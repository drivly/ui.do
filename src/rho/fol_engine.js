 ...
 * @param {any} command_val
 * @param {any} population_val
 * @returns {any}
 */
export function apply_command_wasm(command_val, population_val) {
    const ret = wasm.apply_command_wasm(command_val, population_val);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function debug_compiled_state() {
    const ret = wasm.debug_compiled_state();
    return ret;
}

/**
 * @param {any} response_val
 * @param {any} population_val
 * @returns {any}
 */
export function evaluate_response(response_val, population_val) {
    const ret = wasm.evaluate_response(response_val, population_val);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function forward_chain_population(population_val) {
    const ret = wasm.forward_chain_population(population_val);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @param {string} noun_name
 * @returns {any}
 */
export function get_noun_schemas_wasm(noun_name) {
    const ptr0 = passStringToWasm0(noun_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_noun_schemas_wasm(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function get_transitions_wasm(noun_name, current_status) {
    const ptr0 = passStringToWasm0(noun_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(current_status, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.get_transitions_wasm(ptr0, len0, ptr1, len1);
    return ret;
}
 ...
 * @returns {any}
 */
export function induce_from_population(population_val) {
    const ret = wasm.induce_from_population(population_val);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @param {string} ir_json
 */
export function load_validation_model(ir_json) {
    const ptr0 = passStringToWasm0(ir_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.load_validation_model(ptr0, len0);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}
 ...
 * @param {string} noun_name
 * @param {any} _fields_val
 * @param {any} population_val
 * @returns {any}
 */
export function prepare_entity(noun_name, _fields_val, population_val) {
    const ptr0 = passStringToWasm0(noun_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.prepare_entity(ptr0, len0, _fields_val, population_val);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @param {any} fields_val
 * @returns {any}
 */
export function project_entity_wasm(noun_name, entity_id, fields_val) {
    const ptr0 = passStringToWasm0(noun_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(entity_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.project_entity_wasm(ptr0, len0, ptr1, len1, fields_val);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @param {string} goal
 * @param {any} population_val
 * @param {string} world_assumption
 * @returns {any}
 */
export function prove_goal(goal, population_val, world_assumption) {
    const ptr0 = passStringToWasm0(goal, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(world_assumption, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.prove_goal(ptr0, len0, population_val, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
/**
 * @param {any} population_val
 * @param {any} predicate_val
 * @returns {any}
 */
export function query_population_wasm(population_val, predicate_val) {
    const ret = wasm.query_population_wasm(population_val, predicate_val);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @param {number} target_role
 * @param {any} filter_val
 * @param {any} population_val
 * @returns {any}
 */
export function query_schema_wasm(schema_id, target_role, filter_val, population_val) {
    const ptr0 = passStringToWasm0(schema_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.query_schema_wasm(ptr0, len0, target_role, filter_val, population_val);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @param {string} fact_type_id
 * @returns {any}
 */
export function resolve_fact_event(fact_type_id) {
    const ptr0 = passStringToWasm0(fact_type_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.resolve_fact_event(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function rmap_wasm() {
    const ret = wasm.rmap_wasm();
    return ret;
}
 ...
 * @param {string} noun_name
 * @param {any} events_val
 * @param {any} _population_val
 * @returns {any}
 */
export function run_machine_wasm(noun_name, events_val, _population_val) {
    const ptr0 = passStringToWasm0(noun_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.run_machine_wasm(ptr0, len0, events_val, _population_val);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function synthesize_noun(noun_name, depth) {
    const ptr0 = passStringToWasm0(noun_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.synthesize_noun(ptr0, len0, depth);
    return ret;
}
 ...
 * @param {string} domain_ir_json
 * @returns {any}
 */
export function validate_schema_wasm(domain_ir_json) {
    const ptr0 = passStringToWasm0(domain_ir_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.validate_schema_wasm(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('fol_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
